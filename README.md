...
- [ ] 일부 수량에 대해 정가로 결제할지 여부를 입력받는다. (Y/N)
  - ❌ 예외 처리
    - [ ] 입력이 Y나 N이 아닌 경우: [ERROR] 잘못된 입력입니다. Y 또는 N을 입력해 주세요.
...
- [ ] 사용자가 입력한 구매할 상품과 수량으로 주문서를 생성한다.

## 재고 관리

- [ ] 물품 저장소에 물품 목록에 맞게 재고를 채워넣는다.
- [ ] 구매 수량과 각 상품의 재고 수량을 고려하여 재료 부족 여부를 확인한다.
- [ ] 고객이 상품을 구매할 때마다, 결제된 수량만큼 해당 상품의 재고에서 차감하여 수량을 관리한다.

## 프로모션 할인

- [ ] 프로모션 조건을 설정한다. (N개 구매 시 1개 무료 증정)

- [ ] 오늘 날짜가 프로모션 기간 내에 포함된 경우에만 할인을 적용한다.
- [ ] 프로모션 재고가 없을 경우 할인을 적용하지 않는다.
- [ ] 프로모션 적용이 가능한 상품에 대해 고객이 해당 수량보다 적게 구입했는지에 대한 여부를 판단한다.
- [ ] 무료 증정 수량을 계산한다.
